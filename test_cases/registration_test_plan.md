...
- [ ] Заполнить перепутав латиницу с кириллицей.
- [ ] Заполнить email без @.
...
- [ ] Заполнить поле повтор пароля с ошибкой.
- [ ] Заполнить поле пароль без повтора.
- [x] Заполнить неправильно код подтверждения по СМС.  
