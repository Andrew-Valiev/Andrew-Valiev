...
* `x1B[31m`цифра выбор цвета
  ...
  * По умолчанию  39
  * Сброс         0
* `x1B[0m` сброс вернуть все как было, чтобы остальная часть строки не окрашивалась
* `1b[1;31m` жирный
* `https://gist.github.com/fnky/458719343aabd01cfb17a3a4f7296797` шпаргалка
* `https://www.lihaoyi.com/post/BuildyourownCommandLinewithANSIescapecodes.html` тут много примеров
