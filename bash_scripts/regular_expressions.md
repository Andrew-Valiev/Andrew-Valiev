...
* `.*[]^${}\+?|()`
* `"?"` соответствует повторению предшествующего символа ноль или один раз (то есть flavou?r будет соответствовать flavor и flavour)
* `"*"` - ноль или более раз
* `"+"`- один или более раз
...
* диапазоны можно создавать и из чисел
  ...
  * `echo "123" | awk '/[0-9][2-9][0-9]/'` каждому диапазону соответствует первыя цифра в `echo`
* в класс символов могут входить несколько диапазонов
  ...
  * `[1-31]` это не диапазон от 1 до 31, эта запись читается так диапазон от 1 до 3 и число 1
